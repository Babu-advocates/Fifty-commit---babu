...
import { HelpCircle, Send, User, FileText, Paperclip, Upload, X, MessageSquare } from "lucide-react";
    ...
    try {
      ...
      if (files.length > 0) {
        for (const file of files) {
          ...
          const fileName = `${applicationId}_${Date.now()}_${Math.random().toString(36).substr(2, 9)}.${fileExt}`;
